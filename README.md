...
![](serversphere.drawio.svg)

## Зависимости фронта и бека

```
bash dependencies_install_front.sh
```

## Запуск бека
**Сначала необходимо выполнить пункт зависимостей**
```
bash startup_back.sh 
```

## Запуск фронта
**Сначала необходимо выполнить пункт зависимостей**
```
bash startup_front.sh 
```